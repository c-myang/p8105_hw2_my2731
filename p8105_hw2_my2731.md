...
The data `pols-month` contains 822 observations of 9 variables related
...
party the president was affiliated with at the time.

The data `snp` contains 787 observations of 3 variables. Its main
...
The data `unemployment` contains 816 observations of 3 variables. Its
