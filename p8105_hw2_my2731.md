...
for each month between 1947 and June 2015.

The file `snp` contains 787 observations of the closing price of
Standard & Poor’s stock market index (S&P), often used as a
representative measure of stock market as a whole, for each month
between 1950 and July 2015.

The file `unemployment` contains 816 observations of 3
variables:`pct_unemployed` is the unemployment rate for each month
