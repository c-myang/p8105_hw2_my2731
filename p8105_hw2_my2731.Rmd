...
We can see that there are 10 variables and 60 observations in our A_stations dataset, indicating **60** unique stations that serve the A line.
...
Finally, we will join the datasets by merging `snp` into `pols`, and merging unemployment into the final dataset, `five_thirty_eight`.
